...
public:
    ...
    Status add_rows_selective(RuntimeState* state, vectorized::Chunk* chunk, const uint32_t* row_indexes, size_t from,
                              size_t size);
...
Status DataStreamSender::Channel::add_rows_selective(RuntimeState* state, vectorized::Chunk* chunk,
                                                     const uint32_t* indexes, size_t from, size_t size) {
